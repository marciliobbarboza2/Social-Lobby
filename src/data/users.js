export const users = [
    {
      ...
      coverPhoto: 'https://picsum.photos/800/300?random=julia',
      bio: 'Full-stack engineer building scalable web applications and cloud infrastructure',
      address: '456 Innovation Blvd, Seattle, WA',
      phone: '+1 (555) 333-4444',
      city: 'Seattle',
      groups: ['Cloud Engineers', 'JavaScript Community', 'API Architects'],
      maritalStatus: 'Single',
      birthday: 'July 22, 1994',
      profession: 'Full Stack Engineer',
      location: 'Seattle, WA',
      education: 'MIT',
      work: 'CloudTech Solutions',
      relationship: 'Single',
      joined: 'February 2020',
      gender: 'Female',
      website: 'https://julia.tech',
      languages: ['English', 'Mandarin'],
      interests: ['Cloud Computing', 'DevOps', 'API Design', 'Microservices', 'System Architecture'],
